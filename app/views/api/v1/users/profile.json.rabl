...
child(@user) do
	attributes :id, :name, :designation, :education, :phone_no, :mobile_no1, :mobile_no2, :home_taluka, :present_post, :posting_taluka, :batch, :other_info, :past_postings, :additional_info, :achievements, :home_district, :posting_district, :email, :date_of_joining_cadra, :date_of_birth, :date_of_join_dept, :posting_date, :authentication_token, :access_permission
